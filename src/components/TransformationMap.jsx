...
const TransformationMap = (props) => {
  const {initialData,completeData,radius,width,height} = props; 
...
//debugger;
      ...
      const text = field.selectAll("text")
        ...
        .html((d, i) => {
          let retelement;
          completeData.nodes.forEach((item, index) => {
      ...
      const fieldCircle = fieldTick.append("path")
        ...
        .on('click', (e) => {
          ...
          completeData.nodes.forEach(item =>{
          ...
          if (group === 1) {
            ...
            const a = completeData.links.map(item => {
            ...
            const b = parentOfId.filter(item => {
              const links = completeData.links.filter(i => {
